<x-modal title="Ajouter une rue" subtitle="Ajoute une rue du quartier pour pouvoir y rattacher des villas." back="{{ route('streets.index') }}">
    <x-slot:icon>
    ...
    <form method="POST" action="{{ route('streets.store') }}" data-turbo-frame="_top">
        @csrf
